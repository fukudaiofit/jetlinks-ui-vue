<template>
    <j-input-group compact>
        <j-select
            :options="[
                { label: t('Notify.variableItem.BuildIn.5rg4u0cs8gg0'), value: 'fixed' },
                { label: t('Notify.variableItem.BuildIn.5rg4u0csd1s0'), value: 'upper' },
            ]"
            style="width: 120px"
            :value="value?.source"
            @change="sourceChange"
        ...
        <template v-if="source === 'upper'">
            <j-tree-select
                ...
                :placeholder="t('Notify.variableItem.BuildIn.5rg4u0csdog0')"
        ...
        <template v-else>
            ...
            <j-input-number
                ...
                :placeholder="`${t('Notify.variableItem.BuildIn.input') + item.name}`"
                @change="itemOnChange"
            />
            <j-input
                :value="value.value"
