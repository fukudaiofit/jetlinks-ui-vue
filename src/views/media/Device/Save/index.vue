...
<template>
    <page-container>
        ...
        <SaveProduct v-model:visible="saveProductVis" v-model:productId="formData.productId" :channel="formData.channel"
