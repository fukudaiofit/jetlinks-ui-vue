        ...
        <FullPage>
            <j-card>
                <div class="container">
                    ...
                    >
                        <j-row :gutter="[24, 0]">
                            <j-col :span="12">
                                <j-form-item
                                    :label="t('Type.Detail.index.5rg3eiq3c2w0')"
                                    name="name"
                                    :rules="Rules.name"
                                >
                                    <j-input
                                        v-model:value="formData.name"
                                        :placeholder="t('Type.Detail.index.5rg3eiq3d2g0')"
                                    />
                                </j-form-item>
                            </j-col>
                            <j-col :span="12">
                                <j-form-item
                                    :label="t('Type.Detail.index.5rg3eiq3d8g0')"
                                    name="type"
                                    :rules="Rules.type"
                                >
                                    <j-select
                                        ...
                                        :options="typeOptions"
                                        :placeholder="t('Type.Detail.index.5rg3eiq3dd00')"
                                        allowClear
                                        show-search
                                ...
                                >
                                    ...
                                    >
                                        <j-radio-button :value="true"
                                            >{{t('Type.Detail.index.5rg3eiq3dlg0')}}</j-radio-button
                                        >
                                        <j-radio-button :value="false"
                                            >{{t('Type.Detail.index.5rg3eiq3dpg0')}}</j-radio-button
                                        >
                                    </j-radio-group>
                                </j-form-item>
                            </j-col>
                        ...
                        >
                            ...
                            >
                                        ...
                                        <template #extra v-if="!shareCluster">
                                            ...
                                            >
                                                <span class="delete-btn">
                                                    {{t('Type.Detail.index.5rg3eiq3dtc0')}}
                                                </span>
                                            </j-popconfirm>
                                        </template>
                                        <j-row :gutter="[24, 0]">
                                            ...
                                            >
                                                <j-form-item
                                                    ...
                                                    :label="t('Type.Detail.index.5rg3eiq3dxg0')"
                                                ...
                                                >
                                                    <j-select
                                                        ...
                                                        "
                                                        :placeholder="t('Type.Detail.index.5rg3eiq3e180')"
                                                        allowClear
                                                        show-search
                                                        :filter-option="
                                                            filterOption
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <!-- <j-select
                                                        ...
                                                        "
                                                        :placeholder="t('Type.Detail.index.5rg3eiq3eak0')"
                                                        allowClear
                                                        show-search
                                            ...
                                            >
                                                ...
                                                >
                                                    <template #label>
                                                        {{t('Type.Detail.index.5rg3eiq3eeg0')}}
                                                        <j-tooltip
                                                            :title="t('Type.Detail.index.5rg3eiq3ei80')"
                                                        >
                                                            <AIcon
                                                                type="QuestionCircleOutlined"
                                                                style="
                                                    ...
                                                    <j-select
                                                        ...
                                                        "
                                                        :placeholder="t('Type.Detail.index.5rg3eiq3elw0')"
                                                        allowClear
                                                        show-search
                                                        :filter-option="
                                                            filterPortOption
                                            ...
                                            >
                                                ...
                                                >
                                                    <template #label>
                                                        {{t('Type.Detail.index.5rg3eiq3epg0')}}
                                                        <j-tooltip
                                                            :title="t('Type.Detail.index.5rg3eiq3etg0')"
                                                        >
                                                            <AIcon
                                                                type="QuestionCircleOutlined"
                                                                style="
                                                    ...
                                                    <j-input
                                                        v-model:value="
                                                            cluster
                                                                ...
                                                                .publicHost
                                                        "
                                                        :placeholder="t('Type.Detail.index.5rg3eiq3ex80')"
                                                        allowClear
                                                    />
                                                </j-form-item>
                                            </j-col>
                                            ...
                                            >
                                                ...
                                                >
                                                    <template #label>
                                                        {{t('Type.Detail.index.5rg3eiq3f240')}}
                                                        <j-tooltip
                                                            :title="t('Type.Detail.index.5rg3eiq3f600')"
                                                        >
                                                            <AIcon
                                                                type="QuestionCircleOutlined"
                                                                style="
                                                    ...
                                                    <j-input-number
                                                        style="width: 100%"
                                                        :placeholder="t('Type.Detail.index.5rg3eiq3faw0')"
                                                        v-model:value="
                                                            cluster
                                                                .configuration
                                                                .publicPort
                                            ...
                                            >
                                                <j-form-item
                                                    ...
                                                    :label="t('Type.Detail.index.5rg3eiq3fe40')"
                                                >
                                                    <j-input
                                                        :placeholder="t('Type.Detail.index.5rg3eiq3fic0')"
                                                        v-model:value="
                                                            cluster
                                                                .configuration
                                                                .remoteHost
                                            ...
                                            >
                                                <j-form-item
                                                    :label="t('Type.Detail.index.5rg3eiq3flg0')"
                                                    :name="[
                                                        'cluster',
                                                        index,
                                                        'configuration',
                                                ...
                                                >
                                                    <j-input-number
                                                        style="width: 100%"
                                                        :placeholder="t('Type.Detail.index.5rg3eiq3fpo0')"
                                                        v-model:value="
                                                            cluster
                                                                .configuration
                                                                .remotePort
                                                    ...
                                                    <j-input
                                                        v-model:value="
                                                            cluster
                                                                ...
                                                                .clientId
                                                        "
                                                        :placeholder="t('Type.Detail.index.5rg3eiq3fso0')"
                                                    />
                                                </j-form-item>
                                            </j-col>
                                            ...
                                            >
                                                <j-form-item
                                                    :label="t('Type.Detail.index.5rg3eiq3fw40')"
                                                    :name="[
                                                        'cluster',
                                                        index,
                                                        'configuration',
                                                    ...
                                                    <j-input
                                                        v-model:value="
                                                            cluster
                                                                ...
                                                                .username
                                                        "
                                                        :placeholder="t('Type.Detail.index.5rg3eiq3fzk0')"
                                                    />
                                                </j-form-item>
                                            </j-col>
                                            <j-col
                                            ...
                                            >
                                                <j-form-item
                                                    :label="t('Type.Detail.index.5rg3eiq3g2s0')"
                                                    :name="[
                                                        'cluster',
                                                        index,
                                                        'configuration',
                                                    ...
                                                    <j-input-password
                                                        v-model:value="
                                                            cluster
                                                                ...
                                                                .password
                                                        "
                                                        :placeholder="t('Type.Detail.index.5rg3eiq3g600')"
                                                    />
                                                </j-form-item>
                                            </j-col>
                                            <j-col
                                                    ...
                                                    <j-input
                                                        v-model:value="
                                                            cluster
                                                                ...
                                                                .topicPrefix
                                                        "
                                                        :placeholder="t('Type.Detail.index.5rg3eiq3gc40')"
                                                    />
                                                </j-form-item>
                                            </j-col>
                                                    ...
                                                    <j-input-number
                                                        ...
                                                        v-model:value="
                                                            cluster
                                                                ...
                                                                .maxMessageSize
                                                        "
                                                        :placeholder="t('Type.Detail.index.5rg3eiq3gk00')"
                                                        :min="1024"
                                                        :max="1073741824"
                                                    />
                                                </j-form-item>
                                            ...
                                            <j-col :span="24">
                                                <j-form-item
                                                    :label="
                                                        isVisible(
                                                            ...
                                                            ? t('Type.Detail.index.5rg3eiq3gmw0')
                                                            : t('Type.Detail.index.5rg3eiq3gq40')
                                                    "
                                                    :name="[
                                                        'cluster',
                                                        index,
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <j-radio :value="true"
                                                            >{{t('Type.Detail.index.5rg3eiq3gtg0')}}</j-radio
                                                        >
                                                        <j-radio :value="false"
                                                            >{{t('Type.Detail.index.5rg3eiq3gwk0')}}</j-radio
                                                        >
                                                    </j-radio-group>
                                                </j-form-item>
                                            </j-col>
                                            <div class="form2-row">
                                                ...
                                                >
                                                    <j-form-item
                                                        :label="t('Type.Detail.index.5rg3eiq3gzk0')"
                                                        :name="[
                                                            'cluster',
                                                            index,
                                                            'configuration',
                                                    ...
                                                    >
                                                        <j-select
                                                            ...
                                                            :options="
                                                                certIdOptions
                                                            "
                                                            :placeholder="t('Type.Detail.index.5rg3eiq3h3s0')"
                                                            allowClear
                                                            show-search
                                                            :filter-option="
                                                                filterOption
                                                ...
                                                >
                                                    <j-form-item
                                                        :label="t('Type.Detail.index.5rg3eiq3h700')"
                                                        :name="[
                                                            'cluster',
                                                            index,
                                                            'configuration',
                                                        ...
                                                        <j-input
                                                            v-model:value="
                                                                cluster
                                                                    ...
                                                                    .privateKeyAlias
                                                            "
                                                            :placeholder="t('Type.Detail.index.5rg3eiq3hac0')"
                                                        />
                                                    </j-form-item>
                                                </j-col>
                                            </div>
                                            ...
                                            >
                                                ...
                                                >
                                                    <template #label>
                                                        {{t('Type.Detail.index.5rg3eiq3hdc0')}}
                                                        <j-tooltip
                                                            :title="t('Type.Detail.index.5rg3eiq3hgk0')"
                                                        >
                                                            <AIcon
                                                                type="QuestionCircleOutlined"
                                                                style="
                                                    ...
                                                    <j-select
                                                        ...
                                                        :options="
                                                            ParserTypeOptions
                                                        "
                                                        :placeholder="t('Type.Detail.index.5rg3eiq3hms0')"
                                                        allowClear
                                                        show-search
                                                        :filter-option="
                                                            filterOption
                                            ...
                                            <div class="form2-row">
                                                ...
                                                >
                                                    <j-form-item
                                                        :label="t('Type.Detail.index.5rg3eiq3hps0')"
                                                        :name="[
                                                            'cluster',
                                                            index,
                                                            'configuration',
                                                        ...
                                                        <j-input
                                                            v-model:value="
                                                                cluster
                                                                    ...
                                                                    .delimited
                                                            "
                                                            :placeholder="t('Type.Detail.index.5rg3eiq3hsw0')"
                                                        />
                                                    </j-form-item>
                                                </j-col>
                                ...
                                >
                                    <j-form-item
                                        v-show="false"
                                        :label="t('Type.Detail.index.5rg3eiq3hvw0')"
                                        :name="[
                                            'cluster',
                                            index,
                                            'configuration',
                                    ...
                                    >
                                        ...
                                        />
                                                ...
                                                >
                                                    <j-form-item
                                                        :label="t('Type.Detail.index.5rg3eiq3hz00')"
                                                        :name="[
                                                            'cluster',
                                                            index,
                                                            'configuration',
                                                ...
                                                >
                                                    <j-form-item
                                                        :label="t('Type.Detail.index.5rg3eiq3i200')"
                                                        :name="[
                                                            'cluster',
                                                            index,
                                                            'configuration',
                                                        ...
                                                        <j-input-number
                                                            ...
                                                            v-model:value="
                                                                cluster
                                                                    ...
                                                                    .size
                                                            "
                                                            :placeholder="t('Type.Detail.index.5rg3eiq3i500')"
                                                        />
                                                    </j-form-item>
                                                </j-col>
                                                <j-col
                                                ...
                                                >
                                                    <j-form-item
                                                        :label="t('Type.Detail.index.5rg3eiq3i8c0')"
                                                        :name="[
                                                            'cluster',
                                                            index,
                                                            'configuration',
                                                    ...
                                                    >
                                                        <j-select
                                                            ...
                                                            :options="
                                                                LengthOptions
                                                            "
                                                            :placeholder="t('Type.Detail.index.5rg3eiq3ico0')"
                                                            allowClear
                                                            show-search
                                                            :filter-option="
                                                                filterOption
                                                ...
                                                >
                                                    <j-form-item
                                                        :label="t('Type.Detail.index.5rg3eiq3ifo0')"
                                                        :name="[
                                                            'cluster',
                                                            index,
                                                            'configuration',
                                                        ...
                                                        <j-input-number
                                                            ...
                                                            v-model:value="
                                                                cluster
                                                                    ...
                                                                    .offset
                                                            "
                                                            :placeholder="t('Type.Detail.index.5rg3eiq3iio0')"
                                                            :min="0"
                                                            :max="65535"
                                                        />
                                                    </j-form-item>
                                                ...
                                                >
                                                    <j-form-item
                                                        :label="t('Type.Detail.index.5rg3eiq3ilo0')"
                                                        :name="[
                                                            'cluster',
                                                            index,
                                                            'configuration',
                                                    ...
                                                    >
                                                        <j-select
                                                            ...
                                                            :options="
                                                                LittleOptions
                                                            "
                                                            :placeholder="t('Type.Detail.index.5rg3eiq3ioo0')"
                                                            allowClear
                                                            show-search
                                                            :filter-option="
                                                                filterOption
                            ...
                            <j-form-item v-if="!shareCluster">
                                ...
                                >
                                    ...
                                    {{t('Type.Detail.index.5rg3eiq3irw0')}}
                                </j-button>
                            </j-form-item>
                        </j-form>
                        ...
                        <j-row :gutter="[24, 0]">
                            <j-col :span="24">
                                <j-form-item :label="t('Type.Detail.index.5rg3eiq3ius0')" name="description">
                                    <j-textarea
                ...
                <div class="footer">
                    ...
                    >
                        {{t('Type.Detail.index.5rg3eiq3ixs0')}}
                    </PermissionButton>
                </div>
            </j-card>
        </FullPage>
...
const saveData = async () => {
    ...
    if (!formRef2Data?.cluster) {
        return onlyMessage(t('Type.Detail.index.5rg3eiq3j0o0'), 'error');
    }
    ...
    loading.value = false;
    if (resp?.status === 200) {
        onlyMessage(t('Type.Detail.index.5rg3eiq3j3o0'), 'success');
        history.back();
